  ...
  ({ className, responseFormat = "chatgpt", ...props }: MessageResponseProps) => (
    <Streamdown
      className={cn(
        ...
        // `**texto**` vira <span data-streamdown="strong">, nunca <strong>.
        "[&_strong]:font-bold [&_b]:font-bold [&_[data-streamdown='strong']]:font-bold",
        ...
        "[&>h3]:mt-4 [&>h3]:mb-2 [&>h3]:text-[0.95rem] [&>h3]:font-semibold [&>h3]:text-sky-700 dark:[&>h3]:text-sky-200 [&>h3:first-child]:mt-0",
        responseFormat === "chatgpt"
          ? "message-response-chatgpt"
