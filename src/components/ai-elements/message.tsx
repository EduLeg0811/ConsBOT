...
import type { ResponseFormatId } from "@/lib/chat-settings";
    ...
    <Streamdown
      className={cn(
        ...
        responseFormat === "chatgpt"
          ? "message-response-chatgpt [&>h1]:mt-8 [&>h1]:mb-3 [&>h1]:text-lg [&>h1]:font-semibold [&>h1]:text-[#244d78] [&>h2]:mt-7 [&>h2]:mb-2.5 [&>h2]:text-base [&>h2]:font-semibold [&>h2]:text-[#2d5b87] [&>h3]:mt-6 [&>h3]:mb-2 [&>h3]:text-[0.95rem] [&>h3]:font-semibold [&>h3]:text-[#3a668f] [&>h1:first-child]:mt-0 [&>h2:first-child]:mt-0 [&>h3:first-child]:mt-0"
